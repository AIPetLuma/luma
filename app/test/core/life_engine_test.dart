...
void main() {
  ...
  PetState makePet({int minutesAgo = 60}) => PetState(
        id: 'test-pet',
        name: 'TestLuma',
  ...
  group('TimeSimulator', () {
    ...
    test('short absence barely changes state', () {
      final pet = makePet(minutesAgo: 5);
    ...
    test('1-hour absence increases loneliness noticeably', () {
      final pet = makePet(minutesAgo: 60);
    ...
    test('24-hour absence causes significant loneliness', () {
      final pet = makePet(minutesAgo: 1440);
    ...
    test('generates diary entries for long absences', () {
      final pet = makePet(minutesAgo: 1440); // 24 hours
      final result = simulator.simulate(pet, 1440);
    ...
    test('caps simulation to max hours', () {
      final pet = makePet(minutesAgo: 99999);
